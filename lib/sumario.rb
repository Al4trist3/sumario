class Sumario 
    attr_reader :nro, :caratula, :juzgado, :expediente, :fiscalia, :fecha_inicio, :damnificados, :imputados, :numero_sumario, :caratula_sumario
    ...
    def initialize(args)
        ...
        @caratula_sumario = args[:caratula_sumario]
    end
